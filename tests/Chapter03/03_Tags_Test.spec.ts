...
console.log('test execution started');
// Write a test
test('Capture Screenshots in Playwright 2',{tag: ['@SmokeTesting', '@RegressionTesting']}, async ({ page }) => {
    // Go to URL
    await page.goto('https://www.youtube.com/@testerstalk');
...
console.log('test execution started');
// Write a test
test('Capture Screenshots in Playwright 3',{tag: ['@RegressionTesting']}, async ({ page }) => {
    // Go to URL
    await page.goto('https://www.youtube.com/@testerstalk');
